...
if (isset($_GET['matricula'])) {
    // Recuperar la matrícula desde la URL
    $matricula = $_GET['matricula'];

    // Guardar la matrícula en una variable de sesión
...
if (isset($_POST['from'])) 
{
    ...
    if ($_POST['from']!="" AND $_POST['to']!="") 
    {
       // Recibimos el fecha de inicio y la fecha final desde el form
        ...
        $query="INSERT INTO agenda VALUES(null,'$titulo','$body','','$clase','$inicio','$final','$inicio_normal','$final_normal','$usuario','".$_SESSION['']."')";
        ...
        $link = "$base_url"."descripcion_evento.php?id=$idUsuario";
...
<body style="background: white;">
    <div class="container">
   <a href="<?=$base_url?>btener_eventos.php?id=<?php echo $idUsuario?>">ver</a> 
        <div class="row">
        ...
        (function($){
                ...
                var options = {
                    ...
                    modal: '#events-modal', 
                        ...
                        events_source: "<?=$base_url?>obtener_eventos.php?id=<?php echo $idUsuario?>",                          
